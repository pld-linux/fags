...
FAGS jest "wolnym" klientem AudioGalaxy dla UNIKSA i Linuksa. Został
napisany w C i wydany na licencji GNU General Public License.

FAGS umożliwia do 20 równoczesnych przekazów lub pobrań używając
asynchronicznych gniazd WE/WY. Wspiera także wznawianie transmisji,
dzielenie wielokrotnych katalogów, odczyt tagów ID3 z plików MP3 i Ogg
Vorbis oraz ograniczanie szerokości pasma.
